...
<nav class="navbar navbar-expand-sm bg-primary navbar-dark">
	<ul class="navbar-nav">
		<li class="nav-item active"><a class="nav-link" href="#">완성된 일정</a></li>
		<li class="nav-item"><a class="nav-link" href="#">계획된 일정</a></li>
		<li class="nav-item"><a class="nav-link" href="#">좋아요 한 일정</a></li>
	</ul>
</nav>
<!-- //navbar -->
...
<section class="packages pt-5">
	<div class="container py-lg-4 py-sm-3">
		<h2 class="heading text-capitalize text-center">BEST여행지 5!!</h2>
		<p></p>
...
<section class="destinations py-5" id="destinations">
	<div class="container py-xl-5 py-lg-3">
		<h3 class="heading text-capitalize text-center">배스트 여행지 5 !!!</h3>
		<p class="text mt-2 mb-5 text-center">Vestibulum tellus neque, sodales vel mauris at, rhoncus finibus augue. Vestibulum urna ligula, molestie at ante ut, finibus vulputate felis.</p>
