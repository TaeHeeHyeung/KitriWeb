						...
						<div class="container">
							<div class="w3layouts-banner-info">
								...
								<div class="buttons mt-4">
									<a href="" class="btn mr-2">About타요타요</a> <a href="" class="btn">일정 짜러 가기</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="overlay">
						<div class="container">
							<div class="w3layouts-banner-info">
								...
								<div class="buttons mt-4">
									<a href="" class="btn mr-2">About 타요타요</a> <a href="" class="btn">관광지/맛집 추천</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="overlay">
						<div class="container">
							<div class="w3layouts-banner-info">
								...
								<div class="buttons mt-4">
									<a href="" class="btn mr-2">About 타요타요</a> <a href="" class="btn">여행지 일정 추천</a>
								</div>
							</div>
						</div>
					</div>
