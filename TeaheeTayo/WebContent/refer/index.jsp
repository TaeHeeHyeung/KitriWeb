						...
						<div class="container">
							<div class="w3layouts-banner-info">
								...
								<div class="buttons mt-4">
									<a href="about.html" class="btn mr-2">About타요타요</a> <a
										href="services.html" class="btn">일정 짜러 가기</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="overlay">
						<div class="container">
							<div class="w3layouts-banner-info">
								...
								<div class="buttons mt-4">
									<a href="about.html" class="btn mr-2">About 타요타요</a> <a
										href="booking.html" class="btn">관광지/맛집 추천</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="overlay">
						<div class="container">
							<div class="w3layouts-banner-info">
								...
								<div class="buttons mt-4">
									<a href="about.html" class="btn mr-2">About 타요타요</a> <a
										href="booking.html" class="btn">여행지 일정 추천</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="overlay1">
						<div class="container">
							<div class="w3layouts-banner-info">
								...
								<div class="buttons mt-4">
									<a href="about.html" class="btn mr-2">About 타요타요</a> <a
										href="packages.jsp" class="btn">함께 타기</a>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="row">
			<div class="col-lg-3 col-sm-6">
				<div class="image-tour position-relative">
					...
					<p>
						<span>100 <span class="fa fa-thumbs-up"> | 12230 <span
								class="fa fa-eye"> | 19 <span class="fa fa-comment"></span>
					</p>
				</div>
...
<section class="book py-5">
	<div class="container py-lg-5 py-sm-3">
		<h2 class="heading text-capitalize text-center">TaYo에서 버스 여행을
			꿈꾸세요!</h2>
		<div class="row mt-5 text-center">
			...
			<div class="col-lg-4 col-sm-6 mt-sm-0 mt-5">
				<div class="grid-info">
					...
					<h4>일정짜기</h4>
					<p class="mt-3">
						타요인들의 일정을 참고하여<br>나만의 버스 여행 계획을 짜세요!
					</p>
				</div>
			</div>
