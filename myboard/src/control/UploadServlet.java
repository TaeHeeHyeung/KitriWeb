...
//		//		MultipartRequest mr = new MultipartRequest(request, "E:\\javadata\\workspace\\web\\myboard\\WebContent\\file");
//		MultipartRequest mr = new MultipartRequest(request, saveDirectory, maxPostSize,"UTF-8", fileRenamePolicy);
